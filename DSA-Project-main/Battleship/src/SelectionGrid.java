...
public class SelectionGrid extends Rectangle {
    ...
    public SelectionGrid(int x, int y, boolean isComputerGrid) {
        ...
        showShips = false;
        try {
            VT323 = Font.createFont(Font.TRUETYPE_FONT, new File("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/VT323-Regular.ttf")).deriveFont(40f); // Adjust the font size as needed
            GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
            ge.registerFont(VT323);
            closedtreasureImage = ImageIO.read(new File("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/closed.png"));
            opentreasureImage = ImageIO.read(new File("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/open.png"));
