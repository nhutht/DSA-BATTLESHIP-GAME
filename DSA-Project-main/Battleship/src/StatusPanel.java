...
public class StatusPanel extends Rectangle{
    ...
    public void paint(Graphics g) {
        try {
            audiowide = Font.createFont(Font.TRUETYPE_FONT, new File("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/Audiowide-Regular.ttf")).deriveFont(25f); // Adjust the font size as needed
