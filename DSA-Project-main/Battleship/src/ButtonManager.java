...
public class ButtonManager {
    ...
    static {
        try {
            VT323 = Font.createFont(Font.TRUETYPE_FONT, new File("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/VT323-Regular.ttf")).deriveFont(30f).deriveFont(Font.BOLD); // Adjust the font size as needed
