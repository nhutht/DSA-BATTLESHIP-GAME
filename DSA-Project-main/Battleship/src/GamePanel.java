...
public class GamePanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public GamePanel(Game.GameDifficulty difficulty) {
        try {
            radarBG = ImageIO.read(new File("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/radar.png")); // Load the radar image
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void tryFireAtComputer(Position mousePosition) {
        ...
        // Play the sound
        PlaySound.playSound("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/shoot.wav");
    ...
    private void doPlayerTurn(Position targetPosition) {
        ...
        if(hitTreasure) {
            ...
            timer.schedule(new TimerTask() {
                @Override
                public void run() {
                    PlaySound.playSound("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/treasure.wav");
                }
            }, 50);
        }
        ...
        if(computer.areAllShipsDestroyed()) {
            ...
            PlayVideo.playVideo("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/toothless.mp4"); // Play video
        }
    }
    /**
    ...
    private void doAITurn() {
        ...
        if(player.areAllShipsDestroyed()) {
            ...
            PlayVideo.playVideo("C:/Users/THANHNHU/Downloads/battleshipDSAproject/DSA-Project-main/meme12.mp4"); // Play video
        }
    }
    /**
